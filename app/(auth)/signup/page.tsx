...
import { Mail, Lock, User, Heart, Lightbulb, Users, MessageCircle } from 'lucide-react';
...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform translate-x-2 translate-y-1" style={{ top: '20%', left: '15%', zIndex: 2 }}>
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform -translate-x-1 translate-y-2" style={{ top: '12%', right: '20%', zIndex: 2 }}>
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform translate-x-1 -translate-y-1" style={{ top: '25%', right: '10%', zIndex: 2 }}>
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform -translate-x-2 translate-y-1" style={{ bottom: '25%', left: '15%', zIndex: 2 }}>
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform translate-x-3 -translate-y-2" style={{ bottom: '20%', right: '18%', zIndex: 2 }}>
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform translate-x-1 translate-y-3" style={{ top: '45%', left: '8%', zIndex: 2 }}>
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform -translate-x-1 -translate-y-2" style={{ bottom: '35%', left: '10%', zIndex: 2 }}>
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform translate-x-2 -translate-y-1" style={{ bottom: '45%', left: '22%', zIndex: 2 }}>
        <EngagementBadge 
          icon={MessageCircle} 
          count={31} 
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform -translate-x-3 translate-y-2" style={{ bottom: '30%', right: '25%', zIndex: 2 }}>
        <EngagementBadge 
          icon={Heart} 
          count={31} 
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform translate-x-2 translate-y-1" style={{ top: '50%', right: '8%', zIndex: 2 }}>
        <div className="bg-white rounded-full p-4 shadow-lg">
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform -translate-x-1 translate-y-3" style={{ bottom: '40%', right: '12%', zIndex: 2 }}>
        <div className="bg-white rounded-full p-3 shadow-lg">
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform translate-x-1 -translate-y-2" style={{ top: '35%', right: '15%', zIndex: 2 }}>
      ...
      <FloatingElement className="transition-transform duration-1000 hover:scale-105 transform -translate-x-2 -translate-y-1" style={{ bottom: '15%', left: '25%', zIndex: 2 }}>
      ...
      <div className="flex items-center justify-center min-h-screen p-4 relative" style={{ zIndex: 3 }}>
        <div className="p-8 w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Sign-Up for Cohorts</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
            >
